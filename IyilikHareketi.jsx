...
// =============================================================================
// IYILIK HAREKETI - Editorial Ottoman Modern Design
// =============================================================================
...
const IyilikHareketi = () => {
  ...
  const [iyilikler, setIyilikler] = useState([
    ...
    { id: 3, isim: 'Zeynep', soyisim: 'K.', iyilik: 'Çocuklara kitap bağışladım', tarih: new Date(Date.now() - 7200000) },
    { id: 4, isim: 'Mehmet', soyisim: 'A.', iyilik: 'Hasta arkadaşımı ziyaret ettim', tarih: new Date(Date.now() - 10800000) },
    { id: 5, isim: 'Elif', soyisim: 'S.', iyilik: 'Komşunun çocuğuna ders anlattım', tarih: new Date(Date.now() - 14400000) },
    { id: 6, isim: 'Can', soyisim: 'B.', iyilik: 'İhtiyaç sahibine erzak yardımı', tarih: new Date(Date.now() - 18000000) },
    { id: 7, isim: 'Ayşe', soyisim: 'T.', iyilik: 'Yaşlı teyzeye yol gösterdim', tarih: new Date(Date.now() - 21600000) },
  ]);
  ...
  return (
    <div className="iyilik-app">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,500&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Noto+Nastaliq+Urdu:wght@400;700&display=swap');
