...
// =============================================================================
// IYILIK HAREKETI - Editorial Ottoman Modern Design + Leaderboard
// =============================================================================
...
const IyilikHareketi = () => {
  ...
  const [iyilikler, setIyilikler] = useState([
    { id: 1, isim: 'Ahmet', soyisim: 'Y.', iyilik: 'Yaşlı komşuma market alışverişi yaptım', tarih: new Date(Date.now() - 1800000) },
    { id: 2, isim: 'Fatma', soyisim: 'D.', iyilik: 'Sokak kedilerini besledim', tarih: new Date(Date.now() - 3600000) },
    { id: 3, isim: 'Ahmet', soyisim: 'Y.', iyilik: 'Camiye halı bağışladım', tarih: new Date(Date.now() - 5400000) },
    { id: 4, isim: 'Zeynep', soyisim: 'K.', iyilik: 'Çocuklara kitap bağışladım', tarih: new Date(Date.now() - 7200000) },
    { id: 5, isim: 'Mehmet', soyisim: 'A.', iyilik: 'Hasta arkadaşımı ziyaret ettim', tarih: new Date(Date.now() - 10800000) },
    { id: 6, isim: 'Fatma', soyisim: 'D.', iyilik: 'Komşuya yemek götürdüm', tarih: new Date(Date.now() - 12600000) },
    { id: 7, isim: 'Elif', soyisim: 'S.', iyilik: 'Komşunun çocuğuna ders anlattım', tarih: new Date(Date.now() - 14400000) },
    { id: 8, isim: 'Ahmet', soyisim: 'Y.', iyilik: 'Sokak hayvanlarına su bıraktım', tarih: new Date(Date.now() - 16200000) },
    { id: 9, isim: 'Can', soyisim: 'B.', iyilik: 'İhtiyaç sahibine erzak yardımı', tarih: new Date(Date.now() - 18000000) },
    { id: 10, isim: 'Fatma', soyisim: 'D.', iyilik: 'Yaşlı amcaya marketten yardım ettim', tarih: new Date(Date.now() - 19800000) },
    { id: 11, isim: 'Ayşe', soyisim: 'T.', iyilik: 'Yaşlı teyzeye yol gösterdim', tarih: new Date(Date.now() - 21600000) },
    { id: 12, isim: 'Zeynep', soyisim: 'K.', iyilik: 'Öksüz çocuklara oyuncak aldım', tarih: new Date(Date.now() - 23400000) },
  ]);
    ...
    <div className="iyilik-app">
      <style>{`
        ...
        * {
        ...
        /* Giant background countdown numbers */
        .bg-numbers {
          position: fixed;
          top: 50%;
          left: 50%;
